...
(function($) {
    $.fn.select3 = function(options) {
        ...
        if (opts.width > 0) {
            ...
            $(selectorDown).css('left', (opts.width - 30));
            $(selectorClose).css('left', (opts.width - 60));
        }
