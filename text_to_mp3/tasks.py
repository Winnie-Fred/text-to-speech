...
def convert_text_to_speech(self, text, lang, tld, file_name, context):
    try:
        ...
        # Retrieve the URL for the downloadable MP3
        downloadable_url = cloudinary.utils.cloudinary_url(file_name, resource_type='video', transformation={'flags': f'attachment:{file_name}'})[0]
